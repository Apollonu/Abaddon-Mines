...
ServerEvents.recipes(event => {
	...
	]).transitionalItem('sophisticatedbackpacks:copper_backpack').loops(2)
	...
	]).transitionalItem('sophisticatedbackpacks:iron_backpack').loops(2)
	...
	]).transitionalItem('sophisticatedbackpacks:gold_backpack').loops(2)
