...
ServerEvents.tags('item', event => {
	...
	let individual_items = [
		prefix + 'advanced_processor',
		prefix + 'basic_processor',
		prefix + 'cable',
		prefix + 'construction_core',
		prefix + 'constructor',
		prefix + 'cover',
		...
		prefix + 'hollow_cover',
		prefix + 'importer',
		prefix + 'improved_processor',
		prefix + 'interface',
		prefix + 'network_card',
		prefix + 'pattern',
		prefix + 'portable_grid',
		prefix + 'range_upgrade',
		prefix + 'raw_advanced_processor',
		prefix + 'raw_basic_processor',
		prefix + 'raw_improved_processor',
